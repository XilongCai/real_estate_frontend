...
function ListingDetail() {
        ...
        async function GetListingInfo() {
            try {
                ...
                const response = await Axios.get(
                    `https://lbrepapi.com/api/listings/${params.id}`);
    ...
    useEffect(() => {
        if (state.listingInfo) {
            async function GetProfileInfo() {
                try {
                    const response = await Axios.get(
                        `https://lbrepapi.com/api/profiles/${state.listingInfo.seller}/`
                    );
    ...
    async function deleteHandler() {
        ...
        if (confirmDelete) {
            try {
                const response = await Axios.delete(`https://lbrepapi.com/api/listings/${params.id}/delete/`);
